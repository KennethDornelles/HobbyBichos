...
### 3. ✅ Migration Criada e Aplicada
**Arquivo:** prisma/migrations/20260115160432_add_citext_to_member_code/migration.sql
```sql
CREATE EXTENSION IF NOT EXISTS citext;
...
- ✅ prisma/schema.prisma - Adicionado `@db.Citext`
- ✅ src/modules/users/users.service.ts - Comentários atualizados
- ✅ prisma/migrations/20260115160432_add_citext_to_member_code/migration.sql - Nova migration
