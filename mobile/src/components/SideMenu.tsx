...
const COLORS = {
    brand_primary: "#FFD600",
    background_dark: "#23243A",
    background_light: "#F4F4F6",
    grey_steel: "#D1D5DB",
    error: "#EF4444",
    blue: "#3B82F6",
};
        ...
        <View style={StyleSheet.absoluteFill} pointerEvents={visible ? "auto" : "none"}>
            <Animated.View style={[styles.backdrop, { opacity: fadeAnim }]}>
                <Pressable style={{ flex: 1 }} onPress={onClose}>
                    {/* Garantir que não há texto solto aqui */}
                </Pressable>
            </Animated.View>
            <Animated.View style={[styles.menuContainer, { transform: [{ translateX: slideAnim }], paddingTop: insets.top + 20, paddingBottom: insets.bottom + 20 }]}>
                        ...
                        return (
                            <TouchableOpacity key={item.label} style={styles.menuItem} onPress={handlePress}>
                                <View style={styles.iconWrapper}>
                                    <MaterialIcons name={item.icon} size={22} color={COLORS.grey_steel} />
                                </View>
...
const styles = StyleSheet.create({
    ...
    editLink: { color: COLORS.blue, fontSize: 12, marginTop: 2, fontWeight: "500" },
    ...
    menuItemText: { color: COLORS.grey_steel, fontSize: 16, fontWeight: "500" },
    footer: {
        marginTop: 20,
        borderTopWidth: 1,
